...
curl -u admin:$ORG_ADMIN_TOKEN \
  -X POST '{ "state": "'$1'", "context": "downstream/provider", "description": "Check provider", "target_url": "https://github.com/vmotso-labs/like_provider/actions/runs/'$GITHUB_RUN_ID'" }' \
